...
SYMBOLS = ["AAPL", "MSFT", "TSLA", "GOOGL", "AMZN", "V"]              # 訂閱的股票代碼
...
def on_open(ws, sleep_range=(0.05, 0.2)):
    ...
    for symbol in SYMBOLS:
        ...
        time.sleep(random.uniform(*sleep_range))  # ← 每筆訂閱後等 x 秒
...
if __name__ == "__main__":
    ...
    ws.run_forever(
        reconnect=5,
        ping_interval=60,   # 30 → 60，減少對 Finnhub 的心跳壓力
        ping_timeout=20,    # 10 → 20，給 server 更多時間回 pong
    )
